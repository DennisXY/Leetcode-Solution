...
# of the array are sorted in one container according to their lexicographical o
# rder, then the next permutation of that array is the permutation that follows
